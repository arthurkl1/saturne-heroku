...
@WebServlet("/priveAdmin/admingestionvideos")
public class AdminGestionVideoServlet extends AbstractGenericServlet{
...
private static final long serialVersionUID = -3032812618526895052L;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		templateEngine.process("administration-gestionvideos", context, resp.getWriter());
	}
